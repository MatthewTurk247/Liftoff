...
struct NotificationManager {
    ...
    func repeatNotification() {
        ...
        content.body = factbook[Int(arc4random_uniform(UInt32(factbook.count)) + 1) - 1]
        content.categoryIdentifier = "fact.of.the.day"
        ...
        let trigger = UNCalendarNotificationTrigger(
            ...
            repeats: true)
        let request = UNNotificationRequest(identifier: "fact.of.the.day", content: content, trigger: trigger)
