...
struct Location: Codable {
    let pads: [Pad]
    let id: Int
    let name, infoURL, wikiURL, countryCode: String
}
...
enum Changed: String, Codable {
    case the20170221000000 = "2017-02-21 00:00:00"
    case the20190213123130 = "2019-02-13 12:31:30"
}
